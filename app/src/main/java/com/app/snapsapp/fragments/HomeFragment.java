...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        MainActivity.btnCreateSnap.setVisibility(View.VISIBLE);
//        showProgressDialog();
        ...
        if(MainActivity.list.size()>0){
            ...
            SnapsListAdapter adapter = new SnapsListAdapter(context, MainActivity.list);
            recyclerView.setAdapter(adapter);
        }else {
            textView.setText("No Snaps!");
        }
...
//                    recyclerView.setAdapter(adapter);
//                }else {
//                    textView.setText("No Snaps Created!");
//                }
//                hideProgressDialog();
//            }
//
